...
//             d[x][0] = a[x];
    ...
    public static void main(String[] args) throws IOException, UnsupportedAudioFileException {
        ...
        Xcorr xc=new Xcorr();
        double[] a=xc.generateSignalArray(new File("audio/TV/maggi.wav"));
        double[] b=xc.generateSignalArray(new File("audio/TV/vidMaggi.wav"));
        ...
        if(cmd.equals("conv") || cmd.equals("xcorr"))
        {
            ...
            else
            {
                if(args.length == 1)
                    ...
                    y = DSP.xcorr(b, a, Integer.parseInt("10"));
                ...
                if(args.length == 1)
                    ...
                    y = DSP.xcorr(a,b, Integer.parseInt("10"));
